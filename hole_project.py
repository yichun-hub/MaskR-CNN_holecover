...
DEFAULT_LOGS_DIR = ("/media/sda1/hole_project/hole_logs")
...
class SignDataset(utils.Dataset):
    ...
    def load_sign(self, dataset_dir, subset):
        ...
        self.add_class("hole", 1, "manhole")
        self.add_class("hole", 2, "handhole")
